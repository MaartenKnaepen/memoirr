...
class TestGroqGeneratorComponent:
    ...
    def test_groq_generator_initializes_with_defaults(self):
        ...
        with patch('src.core.config.get_settings') as mock_settings:
            ...
            assert generator.top_p == 1.0
            assert generator.stream is False
    ...
    def test_groq_generator_run_with_parameter_overrides(self):
        ...
        mock_meta = [{"model": "llama3-8b-8192", "finish_reason": "stop"}]
    ...
    def test_groq_generator_run_without_documents(self):
        ...
        mock_meta = [{"model": "llama3-8b-8192", "document_count": 0}]
